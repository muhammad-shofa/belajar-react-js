    ...
    >
      ...
      <div className="flex items-center justify-center h-20">
        <img
          ...
          alt="Profile"
          className={`rounded-full ${isOpen ? "w-12 h-12" : "w-10 h-10"}`}
        />
        {isOpen && (
          <>
            <h1 className="text-black font-medium text-xl ml-3">
              Andreas01 <br />
              <hr /> <b className="txet-bold text-sm text-gray-500">Admin</b>
            </h1>
          </>
        )}
      </div>
